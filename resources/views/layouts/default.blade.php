...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('css/sidebars.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('fontawesome-5.15.4/css/all.min.css') }}">
...
<body>
    ...
    <main>
        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 350px;">
            <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                <!-- <svg class="bi me-2" width="40" height="32"><use xlink:href="#bootstrap"/></svg> -->
                <h1 class="fs-4">Classroom</h1>
            </a>
            <hr>
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item">
                    <a href="/home" class="nav-link text-white {{ Request::path() ==  'home' ? 'active' : ''  }}" aria-current="page">
